...
// console.log("Express + TS, comecando")
...
app.listen(3000, () => {
  console.log("Aplicação de TS + Expres funcionado");
});
...
// 10 - middleware
function getUserAccess(req: Request, res: Response, next: NextFunction) {
  if (req.params.id === "1") {
...
app.get(
  ...
  (req: Request, res: Response) => {
    return res.json({ msg: "Bem vindo ao departamento administrativo" });
  }
);
